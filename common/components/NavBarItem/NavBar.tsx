...
() {
  return (
       <div className=" bg-ui-300 h-screen w-[264px] shadow-black  shadow-2xl fixed pb-[20px] ">
       ...
       <div className="flex items-center text-white  w-[232px] h-[40px] text-[15px]" >
          <a href="" target="_blank" className=" flex items-center justify-center w-[36px] h-[36px]">
        ...
        <div className="px-[16px] h-[60px] flex items-center">
          <div className=" flex items-center  justify-center w-[132px] my-[12px] mr-[32px]  h-[36px] rounded-[14px] bg-ui-500 shadow-lg shadow-black ">
